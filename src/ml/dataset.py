...
class TextClassificationDataset(Dataset):
    ...
    def __init__(self, texts: list, labels: list, tokenizer: BertTokenizer, max_length: int = 512):
        self.texts = texts
        self.labels = labels
...
def save_label_mappings(label2id: Dict[str, int], id2label: Dict[int, str], save_path: str):
    """保存标签映射"""
