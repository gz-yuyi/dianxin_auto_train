...
class ServiceChecker:
    ...
    def prepare_test_data(self) -> Optional[Dict]:
        ...
        training_data = {
            ...
            "training_data_file": os.path.basename(self.test_dataset_path),
    ...
    def create_training_task(self, training_data: Dict) -> Optional[str]:
        ...
        response = requests.post(
            f"{self.base_url}/training/tasks", json=training_data, timeout=30
        )
    ...
    def monitor_task(self, task_id: str, max_wait_time: int = 300) -> bool:
        ...
        while time.time() - start_time < max_wait_time:
            ...
            response = requests.get(
                f"{self.base_url}/training/tasks/{task_id}", timeout=10
            )
    ...
    def verify_task_result(self, task_id: str) -> bool:
        ...
        # 获取任务详情
        response = requests.get(f"{self.base_url}/training/tasks/{task_id}", timeout=10)
